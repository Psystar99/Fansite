...
<div class="container"style="padding: 0 200px 0 200px;">
	<form method="post" action="./userRegister">
		<table class="table table-hover" style="text-align: left; border: 1px solid #fff">
			<tbody>
				<tr>
				...
				<tr>
					<td style="width:130px;"><h5>비밀번호<font class="need">*</font></h5></td>
				...
				<tr>
					<td style="width:130px;"><h5>비밀번호확인<font class="need">*</font></h5></td>
				...
				<tr>
					<td style="text-align: left" colspan="3"><h6 id="passwordCheckMessage"></h6></td>
				</tr>
				<tr>
					<td style="width:130px;"><h5>이름<font class="need">*</font></h5></td>
					<td colspan="2"><input class="form-control" type="text" id="userName" name="userName" maxLength="20"  placeholder="이름을 입력해주세요."></td>
				</tr>
				<tr>
					<td style="width:130px;"><h5>나이<font class="need">*</font></h5></td>
					<td colspan="2"><input class="form-control" type="text" id="userAge" name="userAge" maxLength="20"  placeholder="나이를 입력해주세요."></td>
				</tr>
				<tr>
					<td style="width:130px;"><h5>성별<font class="need">*</font></h5></td>
					<td colspan="2">
			...
			<div class="vertical-alignment-helper">
				<div class="modal-dialog vertical-alignment-center">
					<div id="checkType" class="modal-content panel-info">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-primary" data-dismiss="modal" style="width:150px;">확인</button>
							</div>
					</div>
				</div>
			</div>
